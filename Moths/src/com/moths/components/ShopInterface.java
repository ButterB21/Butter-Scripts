...
public class ShopInterface extends ComponentCentered implements ItemGroup {
    ...
    private final Rectangle TITLE_BOUNDS = new Rectangle(5, 5, 478, 25);
    private final Rectangle CLOSE_BUTTON_BOUNDS = new Rectangle(460, 7, 21, 21);
    ...
    public Point getStartPoint() {
        ...
        // Where first item starts with respect to interface
