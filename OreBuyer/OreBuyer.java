...
public class OreBuyer extends Script {
    ...
    public void onPaint(Canvas c) {
        ...
        c.drawText("Script version:" + version, 10, y += 20, Color.WHITE.getRGB(), ARIEL);
    }
    ...
    private void openShop () {
        ...
        if (selectedShop.isIdleNPC()) {
            ...
            pollFramesHuman(() -> shopInterface.isVisible(), RandomUtils.uniformRandom(6000, 9000));
        }
    }
    ...
    private boolean fillCoalBag (int freeSlots) {
        ...
        if (inventorySnapshot.getRandomItem().interact("Fill")) {
            ...
            }, RandomUtils.uniformRandom(1600,5000));
        }
        return false;
    }
    ...
    private boolean emptyCoalBag() {
        ...
        if (inventorySnapshot.getRandomItem().interact("Empty")) {
            return pollFramesUntil(() -> false, RandomUtils.uniformRandom(1600, 5000));
        }
        return false;
    }
    ...
    private boolean checkForUpdates() {
        String latest = getLatestVersion("https://raw.githubusercontent.com/ButterB21/Butter-Scripts/refs/heads/main/OreBuyer/VERSION.txt");
